...
public class DtoMapper {
    ...
    public TransactionResponse toTransactionResponse(Transaction entity) {
        ...
        return TransactionResponse.builder()
                ...
                .amount(entity.getAmount())
                .type(entity.getType())
                .status(entity.getStatus())  // Directement, sans conversion
                .description(entity.getDescription())
                ...
                .userId(entity.getWallet() != null && entity.getWallet().getUser() != null
                        ...
                        : null)
                .userName(entity.getWallet() != null && entity.getWallet().getUser() != null
                        ? entity.getWallet().getUser().getName()
                        : null)
                .createdAt(entity.getCreatedAt())
                .build();
    }
    ...
    public GamificationResponse toGamificationResponse(Gamification entity) {
        ...
        return GamificationResponse.builder()
                ...
                .organizerId(entity.getOrganizer() != null ? entity.getOrganizer().getId() : null)
                .organizerName(entity.getOrganizer() != null && Hibernate.isInitialized(entity.getOrganizer())
                        ? entity.getOrganizer().getCompanyName() : null)
                .build();
    }
    ...
    public CartResponse toCartResponse(Cart entity) {
        ...
        BigDecimal discountAmount = entity.getDiscountAmount() != null ? entity.getDiscountAmount() : BigDecimal.ZERO;
        ...
        return CartResponse.builder()
                ...
                .finalAmount(entity.getTotalAmount() != null ? entity.getTotalAmount().subtract(discountAmount) : BigDecimal.ZERO)
                .totalItems(entity.getItems() != null ? entity.getItems().size() : 0)
                .updatedAt(entity.getUpdatedAt())
                // NOUVEAUX CHAMPS À AJOUTER
                .appliedCouponCode(entity.getAppliedCouponCode())
                .appliedPromotionId(entity.getAppliedPromotionId())
                .appliedPromotionName(entity.getAppliedPromotionName())
                .build();
    }
